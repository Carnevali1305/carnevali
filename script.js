...
function diagEnviar() {
  ...
  const stepsContainer = document.getElementById('diag-steps-container');
  const diagNav = document.getElementById('diag-nav');
  const diagProgress = document.querySelector('.diag-progress-wrap');
  const successEl = document.getElementById('diag-success');
  if (stepsContainer) stepsContainer.style.display = 'none';
  if (diagNav) diagNav.style.display = 'none';
  if (diagProgress) diagProgress.style.display = 'none';
...
function initStickyCTA() {
  ...
  const roiSection = document.getElementById('diagnostico');
